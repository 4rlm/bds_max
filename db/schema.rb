...
ActiveRecord::Schema.define(version: 20170823113805) do
  ...
  create_table "in_host_pos", id: :serial, force: :cascade do |t|
    t.string "term"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "in_text_pos", id: :serial, force: :cascade do |t|
    t.string "term"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "consolidated_term"
  ...
  create_table "indexer_terms", id: :serial, force: :cascade do |t|
    t.string "category"
  ...
  create_table "indexers", id: :serial, force: :cascade do |t|
    t.string "raw_url"
    ...
    t.string "template_status"
    t.datetime "account_scrape_date"
    t.datetime "page_finder_date"
  end
