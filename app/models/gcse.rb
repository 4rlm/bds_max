...
class Gcse < ApplicationRecord
    ...
    scope :sfdc_url_o, -> (sfdc_url_o) { where("sfdc_url_o like ?", "%#{sfdc_url_o}%") }
    ...
    scope :exclude_root, -> (exclude_root) { where("exclude_root like ?", "%#{exclude_root}%") }
    # scope :in_text_pos, -> (in_text_pos) { where in_text_pos: in_text_pos }
    scope :in_text_pos, -> (in_text_pos) { where("in_text_pos like ?", "%#{in_text_pos}%") }
    # scope :in_text_del, -> (in_text_del) { where in_text_del: in_text_del }
    scope :in_text_del, -> (in_text_del) { where("in_text_del like ?", "%#{in_text_del}%") }
