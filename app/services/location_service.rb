class LocationService
    def create_sfdc_loc(core)
        ...
        return if addr.nil? || core.sfdc_geo_status == "Geo Outbound"
        ...
        if location.save
            core.update_attributes(bds_status: "Geo Outbound", sfdc_geo_status: "Geo Outbound",
    ...
    def create_site_loc(core)
        ...
        return if addr.nil? || core.site_geo_status == "Geo Outbound"
        ...
        if location.save
            core.update_attributes(bds_status: "Geo Outbound", site_geo_status: "Geo Outbound",
